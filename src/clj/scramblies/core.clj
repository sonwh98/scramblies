...
(defn min-frequencies-met?
  "calculates frequencies of letters in str1 and str2.
  returns true of frequencies of letters in str1 is at least the same frequencies as in str2"
  [str1 str2]
  (let [freq-a (frequencies str1)
        freq-b (frequencies str2)
        comparisons (for [[ch count-b] freq-b
